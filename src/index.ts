...
client.on("message", (message: Message) => {
  if (message.content.includes("rickroll"))
    return message.channel.send("http://gph.is/2efdN3V");
    ...
    if (oldMember.channelID == null) {
      ...
      if (rancomNumber > 0.99) {
        newMember!.channel!.join().then((connection) => {
          connection.play(
            "https://cdn.discordapp.com/attachments/872409435392327690/873424995647369256/Rick_Astley_-_Never_Gonna_Give_You_Up_Qoret.com.mp3"
          );
        });
      }
    }
